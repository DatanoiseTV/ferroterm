//! Color resolution for the Slint front-end. Shares the web component's and the
//! native app's palette: the Tokyo Night default theme for the 16 ANSI slots,
//! the standard xterm cube/greys for 16..=255, and the packed-`u32` cell color
//! encoding produced by `ferroterm-core`'s snapshot — so a shell looks
//! identical in the browser, the wgpu app and here.
